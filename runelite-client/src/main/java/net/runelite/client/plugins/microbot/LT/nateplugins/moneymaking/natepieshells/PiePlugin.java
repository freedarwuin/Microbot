...
public class PiePlugin extends Plugin {
    @Inject
    private net.runelite.client.plugins.microbot.nateplugins.moneymaking.natepieshells.PieConfig config;
    ...
    @Inject
    net.runelite.client.plugins.microbot.nateplugins.moneymaking.natepieshells.PieScript pieScript;

    @Provides
    net.runelite.client.plugins.microbot.nateplugins.moneymaking.natepieshells.PieConfig provideConfig(ConfigManager configManager) {
