package net.runelite.client.plugins.microbot.LT.agility.tasks;

import lombok.extern.slf4j.Slf4j;
import net.runelite.api.Skill;
import net.runelite.client.config.ConfigDescriptor;
import net.runelite.client.plugins.microbot.Microbot;
import net.runelite.client.plugins.microbot.LT.agility.AgilityScript;
import net.runelite.client.plugins.microbot.LT.agility.MicroAgilityConfig;
import net.runelite.client.plugins.microbot.LT.agility.MicroAgilityPlugin;
import net.runelite.client.plugins.microbot.LT.agility.requirement.MicroAgilityPrePostScheduleRequirements;
