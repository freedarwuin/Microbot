...
import static net.runelite.client.plugins.microbot.LT.MossKiller.Enums.AttackStyle.MAGIC;
import static net.runelite.client.plugins.microbot.LT.MossKiller.Enums.AttackStyle.RANGE;
