package net.runelite.client.plugins.microbot.LT.nmz;
...
@ConfigInformation(
        "Antes de comenzar: <br>" +
                "<ul>" +
                "<li>Configura tu inventario con los objetos requeridos</li>" +
                "<li>Asegúrate de tener GP en el cofre</li>" +
                "<li>Ten una configuración de sueño previa ya lista</li>" +
                "<li>Activa la opción de Auto-represalia en los ajustes de combate</li>" +
                "</ul>" +
                "<p>Estos pasos son esenciales para que el plugin funcione correctamente.</p>"
)
