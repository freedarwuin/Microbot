...
public class MossKillerScript extends Script {
    ...
    public static int SPINACH_ROLL = 1969;
    public static int STEEL_ARROW = 886;
    public static int IRON_ARROW = 884;
    public static int EARTH_RUNE = 557;
    public static int MAGIC_STAFF = 1389;
    // TODO: add stuff for boss too
    public int[] LOOT_LIST = new int[]{MOSSY_KEY, LAW_RUNE, AIR_RUNE, FIRE_RUNE, COSMIC_RUNE, DEATH_RUNE, CHAOS_RUNE, NATURE_RUNE,EARTH_RUNE, SPINACH_ROLL, IRON_ARROW, STEEL_ARROW, MAGIC_STAFF, STEEL_KITESHIELD, MITHRIL_SWORD, BLACK_SQ_SHIELD};
