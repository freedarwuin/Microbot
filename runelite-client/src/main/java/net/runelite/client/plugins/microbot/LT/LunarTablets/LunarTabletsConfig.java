package net.runelite.client.plugins.microbot.LT.LunarTablets;
...
@ConfigInformation("Comienza en la Isla Lunar con los hechizos Lunares. Asegúrate de tener equipado tu bastón de X y suficientes runas de ley, astrales y arcilla blanda.")
