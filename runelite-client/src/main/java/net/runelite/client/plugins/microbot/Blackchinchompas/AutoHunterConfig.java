...
public interface AutoHunterConfig extends Config {
    ...
    default int minSleepAfterCatch() { return 8300; }
    ...
    default int maxSleepAfterCatch() { return 8400; }
    ...
    default int minSleepAfterLay() { return 5500; }
    ...
    default int maxSleepAfterLay() { return 5700; }
}
